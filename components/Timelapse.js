            ...
            <div className="row">
                    <div className={styles.aboutus}>
                        ...
                        <div  className={styles.featurecontent}>
                                    <h5 style={{color:"#023047",fontWeight:"normal"}} >Schooling And JEE Preparation</h5>
                                ...
                                <div className={styles.featurecontent}>
                                    <h5 style={{color:"#023047",fontWeight:"normal"}} >College</h5>
                                ...
                                <div  className={styles.featurecontent}>
                                    <h5 style={{color:"#023047",fontWeight:"normal"}} >Life Ahead</h5>
                                    <p style={{color:"#6c757d"}}>Lifes uncertain though but in this uncertainty i search for hope. Hope to become better as a person, as a Developer and a Citizen of my Country too. In all this foggy way i will keep my aim to smile always.</p>
                                </div>
                    </div>
